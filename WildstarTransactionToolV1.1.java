...
public class WildstarTransactionTool
{
    public static void main (String[] args)
    {
        ...
        //Converting WildStar currency types into copper coins to enable easy percentage calculation
        totalCopper = copper + 100 * (silver + 100 * (gold + 100 * platinum));
        
        //Subtracting the percent from totalCopper and storing the resultant value in totalCopperAfterCut
